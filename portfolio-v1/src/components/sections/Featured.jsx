          ...
          <div className="featured__content">
            ...
            <div className="featured__description--container">
              <p className="featured__text">
                ...
                amet, excepturi, vero atque quidem sapiente ab cumque deserunt
                provident beatae aperiam ad placeat suscipit laboriosam autem
                magni laudantium, temporibus enim!
              </p>
            </div>
